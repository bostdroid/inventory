                    ...
                    <div class="main-content-inner">
                        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                            <ul class="breadcrumb">
                             ...
                             <s:form id="myForm" method="post" action="findbalancesByCriteria">     
...
<!--                                                            <td class="hidden-480">
                                                            ...
                                                            <td class="hidden-480">
                                                                <s:property value="tranTime"/>
                                                            </td>
<!--                                                            <td class="hidden-480">
                                                                <%--<s:property value="startDate"/>--%>
                                                            </td>-->
                                                            <td class="hidden-480">
                                                                <s:property value="preCount1"/>
                                                            </td>
                                                            <td class="hidden-480">
                                                                <s:property value="postCount1"/>
                                                            </td>
                                                            <td class="hidden-480">
